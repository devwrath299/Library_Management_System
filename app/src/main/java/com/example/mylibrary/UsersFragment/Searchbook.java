 ...
 * Use the {@link Searchbook#newInstance} factory method to
...
public class Searchbook extends Fragment {
     ...
     * @return A new instance of fragment Searchbook.
     */
    // TODO: Rename and change types and number of parameters
    public static Searchbook newInstance(String param1, String param2) {
        Searchbook fragment = new Searchbook();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        DatabaseReference reference=FirebaseDatabase.getInstance().getReference().child("admin").child(s1).child("Books");
        list = new ArrayList<>();
